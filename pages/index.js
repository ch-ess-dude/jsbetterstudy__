...
export default function Home() {
      ...
      <nav className="sticky top-0 bg-white shadow-md">
        <div className="max-w-4xl mx-auto flex items-center justify-between p-4">
          ...
          <div className="flex items-center space-x-6">
            ...
            <Link href="/auth" className="pill-cta bg-indigo-600 hover:bg-indigo-700 text-white">Enter Productivity</Link>
          </div>
        </div>
      </nav>
  ...
  <p className="max-w-xl mx-auto text-gray-700 mb-6 animate-fadeIn" style={{ animationDelay: '150ms' }}>Well we did too. Founder Aayaan Sultan and co-founder Ambhrin Mahanty faced frustration and wanted to give up on 'productivity'. Then we figured, 'Why don’t we make something to help us?' From that, JsBetter was birthed, with its priority product, JsBetter Study, which combines all the best and effective methods, for your productivity and convenience! Enjoy Launch Trial for the foreseeable future, because paywalls aren’t great. Here’s to completing goals, and LOCKING IN.</p>
        <div className="mt-6">
          <Link href="/auth" className="inline-block pill-cta bg-indigo-600 hover:bg-indigo-700 text-white">Enter Productivity</Link>
        </div>
      </main>
